...
## My Thoughts
Fun problem, I had a couple hiccups trying to approach it. I then misread and thought `round(x)` was enough, however, I needed to round up so I used `math.ceil` from the math library.
